...
void pkchar(float *array, int ndxmx, float si, int ndxpk, char *ktype,
            char *kdir, char *kqual);
...
void wavfrm(float array[], int nst, int nlen, double value, int mwf, int iwf[],
            int *lwfok);
void xfid(int *nerr);
...
int calc_time_offsets(int lrelative, double *toff, int n1, int n2, double *ptmin, double *ptmax);
