...
void beginwindow2(int *number, int *nerr);
void calc_loc2(unsigned int *xloc, unsigned int *yloc,
               unsigned int *cbarxoffset, unsigned int *cbaryoffset,
               unsigned int w_width, unsigned int w_height,
               unsigned int i_width, unsigned int i_height, double xpmn,
               double xpmx, double xmin, double first, double last, double ypmn,
               double ypdel, double vsratio, int *nerr);
void cbar_window2(unsigned int xloc, unsigned int yloc, unsigned int height,
...
void createwindow2(int *number, float *xwinmn, float *xwinmx, float *ywinmn,
...
void erase2(void);
char *fill_clrbar2(int npseudocolors, int width, int npricolors, int ndefcolors,
                   int *nerr);
char *fill_image2(unsigned int height, unsigned int width, float data[],
                  float dmin, float range, int npseudocolors, int nsaccolors,
                  int ndefcolors, int *nerr);
void flushbuffer2(int *nerr);
void get_geometry2(int number, unsigned int *width_return,
                   unsigned int *height_return, int *nerr);
void getalphainfo2(int *nlines, char *erase, int len);
void getdeviceinfo2(char *kdname, int kdname_s, int *idtype);
...
void setsgfdir(char *dir, int dir_s);
void setsgfnumber(int number);
void setsgfprefix(char *prefix);
void setsgfsize(char *type, double value);
void settextangle2(float angle);
void settextsize2(float width, float height);
void setwidth2(int index);
void calculate_location2(float *x, float *y, float *cx, float *cy,
                         unsigned int w, unsigned int h, unsigned int iw,
                         unsigned int ih);
void show_image_sgf(float *data, unsigned int iw, unsigned int ih, float xmin,
