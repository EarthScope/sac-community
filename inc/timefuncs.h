...
extern double tmMakeEpochTime(int year, int month, int day, int hour, int min,
                              float second);
...
extern enum warning { NoTimeError, ProbableTimeError,
        SevereTimeError } warningLevel;
