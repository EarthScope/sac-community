...
int backspace(FILE * stream, int n);
void ext_init(void);
char *fstrncpy(char *to, int tolen, char *from, int fromlen);
int getfline(FILE * pfd, char *pch, int maxlen);
int getline_sac(FILE * pfd, char *pch, int maxlen);
short int izshft(short int *pint, short int *pnumshft);
...
char *strscpy(char *to, char *from, int l);
char *subscpy(char *to, int start, int end, int len, char *from);
void tokenize(char ***argv, int *argc, char *linein, int *nerr);
void zauxfile(char *ksub, int ksub_s, char *kfile, int kfile_s, int *nerr);
void zbasename(char *name, int name_len);
char *sacaux();
void zclose(int *nfu, int *nerr);
void zclosec(int *pfd);
void zcloses(FILE ** nfu, int *nerr);
void zdest(char *kname, int kname_s, int *nerr);
void zdestf(char *kbase, int kbase_s, int *nerr);
void zexecute(int index, int *nerr);
string_list *zfiles(char *kdirin, char *kpatrn, int *nErr);
void zgetc(int *array, char *str, int pnumc);
void zgetgd(char *name, int name_len);
void zgimsg(int argc, char **argv, char *mess, int messlen);
void zgpmsg(char *prmt, int prmtlen, char *msg, int msglen);
void zgtmsg(char *prmt, int prmtlen, char *msg, int msglen);
...
void zrun(FILE ** nfun, char *runfile, int runfile_s, int *nerr);
void zrunname(char *name, int name_s, char *args, int args_s, FILE ** nfun,
              char *runfile, int runfile_s, int *nerr);
void zruntext(char *text, int text_s, FILE * nfun, int *nerr);
