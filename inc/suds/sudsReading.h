...
int FillTrigSettingStruct(SUDS_TRIGSETTING * ts, SUDS_STRUCTTAG Tag,
                          FILE * ptr);
int FillEventSettingStruct(SUDS_EVENTSETTING * es, SUDS_STRUCTTAG Tag,
                           FILE * ptr);
int FillStationCompStruct(SUDS_STATIONCOMP * sc, SUDS_STRUCTTAG Tag,
                          FILE * ptr);
int FillDescripTraceStruct(SUDS * S, SUDS_DESCRIPTRACE * dt, SUDS_STRUCTTAG Tag,
                           FILE * ptr);
...
int FillCommentStruct(SUDS * S, SUDS_COMMENT * co, SUDS_STRUCTTAG Tag,
                      FILE * ptr);
...
int FillTimeCorrectionStruct(SUDS_TIMECORRECTION * tc, SUDS_STRUCTTAG Tag,
                             FILE * ptr);
...
int FillChansetStruct(SUDS * S, SUDS_CHANSET * cs, SUDS_STRUCTTAG Tag,
                      FILE * ptr);
