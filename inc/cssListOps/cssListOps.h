...
void dblCopyTableElement(dblObject StrucType, DBelement origPntr,
                         DBtable copyPntr);
...
DBtable dblNextTableInstance(DBtable tableInstance, DBlist dblList,
                             dblObject specifier);
void dblSetTraceData(DBtable tableInstance, DataType dtype, void *data,
                     int npts);
int dblGetTableIndex(dblObject StrucType, DBtable pntr);
int dblAddComment(DBlist list, dblObject StrucType, DBtable rowPntr,
                  const char *comment);
char **dblGetComments(DBlist list, dblObject StrucType, DBtable rowPntr,
                      int *Nlines);
...
void dblSetUserDataComData(DBdataComm DCpntr, const ComplexFloat * data,
                           int Npts);
...
void dblPrintTableInstance(DBtable tableInstance, dblObject specifier,
                           FILE * unit);
