...
void setvport(double xmin, double xmax, double ymin, double ymax);
void setvportratio(double ratio);
void setworld(double xwmin, double xwmax, double ywmin, double ywmax);
void symbol(double xloc[], double yloc[], int number, int lnewdp);
void vporttoworld(double xloc, double yloc, float *xwloc, float *ywloc);
void worldcursor(float *xwloc, float *ywloc, char *kchar);
void worlddraw(double xwloc, double ywloc);
void worldline(double xwloc1, double ywloc1, double xwloc2, double ywloc2);
void worldmove(double xwloc, double ywloc);
void worldpolyline(double xwloc[], double ywloc[], int number);
void worldpolylinef(float xwloc[], float ywloc[], int number);
void worldsector(double xwcen, double ywcen, double radius, double deg1,
                 double deg2, double degi);
void worldtovport(double xwloc, double ywloc, float *xloc, float *yloc);
void xaxis(char *type, char *annot, char *ticks, char *label, int label_s);
void xlinaxis(int lbotax, int ltopax, int lbottc, int ltoptc, float *widbot,
              float *widtop);
void xlogaxis(int lbotax, int ltopax, int lbottc, int ltoptc, float *widbot,
              float *widtop);
void yaxis(char *type, char *annot, char *ticks, char *label, int label_s);
void ylinaxis(int llefax, int lrigax, int lleftc, int lrigtc, float *widlef,
              float *widrig);
