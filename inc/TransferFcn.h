...
int GetTheoreticTransferFcn(enum InstrumentType InstType, int NumFreqs,
                            double DelFreq, double *RealArray,
                            double *ImagArray);

int TransferFcnFromPoleZeroFile(char *Dir, char *file, int Npts, double DelFreq,
                                double *Real, double *Imag);

int TransferFcnFromEvresp(char *station, char *component, char *units,
                          char *net_code, double EpochTime, int Verbose,
                          char *Dir, char *file, int nfreq, double delfrq,
