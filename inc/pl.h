...
void iniwidth(void);
void logdta(float array[], int number, int lfloor, double floor, float output[],
            int *nerr);
...
void plblank(float xblank[], float yblank[], float xarray[], float yarray[],
             int number);
void plcalwvtrans(void);
void plclip(float xarray[], float yarray[], int number, int lnewdp);
...
void plmap(float xarray[], float yarray[], int number, int incx, int incy,
           int *nerr);
void plnocl(float xarray[], float yarray[], int *number, int lnewdp);
void plplab(void);
void plrest(void);
void plsave(void);
