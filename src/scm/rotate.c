...
void
rotate(float si1[], float si2[], int ns, double angle, int lnpi, int lnpo,
       float so1[], float so2[]) {
    int js;
...
void
rotate_(float si1[], float si2[], int *ns, double *angle, int *lnpi, int *lnpo,
        float so1[], float so2[]) {
    rotate(si1, si2, *ns, *angle, *lnpi, *lnpo, so1, so2);
}

void
rotate__(float si1[], float si2[], int *ns, double *angle, int *lnpi, int *lnpo,
         float so1[], float so2[]) {
    rotate(si1, si2, *ns, *angle, *lnpi, *lnpo, so1, so2);
}
