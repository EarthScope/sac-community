...
void
softwaretext(display_t * out, char *ktext, int ntext) {
    int italic, rotate;
    int ich, index, j, jopcode, jstroke, jstxmn, jstxmx, jxdel, jydel;
    float hfactr, rotrad, sqxy, theta, wfactr, xdel, xsav, ydel, ysav;
