        ...
        if (lkra("SPACING$", 9, 1, 3, spacing, &nspacing)) {
          ...
          L_1100:
            ...
            if (itype > 0) {
                nc = ic2 - ic1 + 1;
                j = min(j + 1, MZLEVELS);
                fstrncpy(kmcontouring.klabellist[j - 1], 16, klist + ic1 - 1,
                         min(ic2, MCMSG) - ic1 + 1);
                ...
                if (strcmp(kmcontouring.klabellist[j - 1], "on              ")
                    ...
                    if (strcmp
                        (kmcontouring.klabellist[j - 1],
                         "off             ") == 0) {
                    strcpy(kmcontouring.klabellist[j - 1], "OFF             ");
                } else if (memcmp(kmcontouring.klabellist[j - 1], "int", 3) ==
                           0) {
                    strcpy(kmcontouring.klabellist[j - 1], "INT             ");
                } else if (memcmp(kmcontouring.klabellist[j - 1], "float", 5) ==
                           0) {
                ...
                } else if (memcmp(kmcontouring.klabellist[j - 1], "exp", 3) ==
                           0) {
