     ...
     double freq, yt;
{
    int i, i_, j, j_, k;
    float filtk_v;
    static double a[4], b[4], e1[3][4], e2[3][4], e3[3][4], e4[3][4], wct, wct2;
  ...
  L_2000:
    ;
    e1[2][iopt - 1] =
        (wct2 * yt + B[1] * e1[1][iopt - 1] - e1[0][iopt - 1]) / A[1];

    e2[2][iopt - 1] =
        (wct2 * e1[2][iopt - 1] + B[2] * e2[1][iopt - 1] -
         e2[0][iopt - 1]) / A[2];

    e3[2][iopt - 1] =
        (wct2 * e2[2][iopt - 1] + B[3] * e3[1][iopt - 1] -
         e3[0][iopt - 1]) / A[3];

    e4[2][iopt - 1] =
        (wct2 * e3[2][iopt - 1] + B[4] * e4[1][iopt - 1] -
         e4[0][iopt - 1]) / A[4];
