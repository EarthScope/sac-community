...
double /*FUNCTION*/
filtb(int iopt, float xt) {
    int i, i_, j;
    static int icnt[4];
    float filtb_v;
    static double a, aa, atk, b, btk, c, con1, con2, ga1, ga2, ga3, gb1, gb2,
        gb3, hp1, hp2, lp1, lp2, lp3, ng, rad, rt, s1, s2, s3, s4, t1, t2, t3,
        th1[3][4], th1a, th2[2][4], th2a, th3[4], th3a, th4[2][4], th4a,
        th5[2][4], th5a, wb1, wf1, wg1, x1[3][4], x2[2][4], x3[4], x4[2][4],
        x5[2][4];
    ...
    rt = 163.3e0 + rd - 500.0e0 * (btk - 1.0e0 +
                                   (1280.0e0 * btk / con1)) / con2;
     ...
     * */
    ng = hg + tg * tg / ert * (9.0e0 * atk * atk -
                               1.0e0) / 2.0e0 / wg / (1471.5e0 * atk * atk -
                                                      3.5e0);
    rad = wg / t1;
  ...
  L_2100:
    th1a =
        s1 * (xt - x1[0][iopt - 1] - x1[1][iopt - 1] + x1[2][iopt - 1]) +
     ...
     * */
    th2a =
        ga1 * (th1a + 2.0e0 * x2[0][iopt - 1] + x2[1][iopt - 1]) +
     ...
     * */
    th4a =
        lp1 * (th3a + 2.0e0 * x4[0][iopt - 1] + x4[1][iopt - 1]) +
     ...
     * */
    th5a =
        gb1 * (th4a + 2.0e0 * x5[0][iopt - 1] + x5[1][iopt - 1]) +
