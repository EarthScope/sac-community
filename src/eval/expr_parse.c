...
static const YYACTIONTYPE yy_action[] = {
    /*     0 */ 4, 183, 24, 164, 97, 176, 175, 8, 7, 82,
    /*    10 */ 172, 171, 170, 163, 165, 136, 13, 15, 14, 134,
    /*    20 */ 14, 172, 171, 170, 42, 117, 174, 169, 168, 167,
    /*    30 */ 59, 58, 57, 56, 55, 54, 53, 52, 51, 50,
    /*    40 */ 49, 48, 47, 46, 93, 92, 45, 44, 43, 23,
    /*    50 */ 22, 21, 20, 19, 18, 86, 41, 40, 39, 37,
    /*    60 */ 61, 35, 72, 32, 30, 28, 6, 4, 135, 24,
    /*    70 */ 164, 91, 12, 175, 101, 100, 82, 172, 171, 170,
    /*    80 */ 163, 165, 136, 87, 85, 10, 134, 129, 172, 171,
    /*    90 */ 170, 42, 161, 174, 169, 168, 167, 59, 58, 57,
    /*   100 */ 56, 55, 54, 53, 52, 51, 50, 49, 48, 47,
    /*   110 */ 46, 93, 92, 45, 44, 43, 23, 22, 21, 20,
    /*   120 */ 19, 18, 86, 41, 40, 39, 4, 120, 24, 164,
    /*   130 */ 104, 118, 175, 102, 33, 82, 172, 171, 170, 163,
    /*   140 */ 165, 136, 103, 38, 90, 134, 295, 172, 171, 170,
    /*   150 */ 42, 160, 174, 169, 168, 167, 59, 58, 57, 56,
    /*   160 */ 55, 54, 53, 52, 51, 50, 49, 48, 47, 46,
    /*   170 */ 93, 92, 45, 44, 43, 62, 256, 256, 295, 175,
    /*   180 */ 295, 295, 41, 40, 39, 295, 37, 61, 35, 72,
    /*   190 */ 32, 30, 28, 6, 295, 295, 139, 42, 295, 174,
    /*   200 */ 169, 168, 167, 59, 58, 57, 56, 55, 54, 53,
    /*   210 */ 52, 51, 50, 49, 48, 47, 46, 93, 92, 45,
    /*   220 */ 44, 43, 119, 295, 17, 16, 13, 15, 14, 41,
    /*   230 */ 40, 39, 3, 295, 62, 1, 71, 99, 175, 182,
    /*   240 */ 179, 178, 177, 116, 115, 114, 113, 112, 111, 110,
    /*   250 */ 109, 108, 17, 16, 13, 15, 14, 107, 174, 169,
    /*   260 */ 168, 167, 3, 295, 62, 257, 257, 295, 175, 11,
    /*   270 */ 179, 178, 177, 116, 115, 114, 113, 112, 111, 110,
    /*   280 */ 109, 108, 63, 295, 295, 139, 295, 107, 174, 169,
    /*   290 */ 168, 167, 64, 295, 62, 295, 295, 295, 175, 295,
    /*   300 */ 133, 132, 131, 294, 98, 25, 106, 180, 295, 105,
    /*   310 */ 264, 264, 295, 295, 172, 171, 170, 295, 174, 169,
    /*   320 */ 168, 167, 5, 295, 62, 295, 295, 2, 175, 62,
    /*   330 */ 139, 295, 164, 175, 295, 295, 295, 295, 78, 172,
    /*   340 */ 171, 170, 163, 295, 88, 295, 295, 295, 174, 169,
    /*   350 */ 168, 167, 164, 174, 169, 168, 167, 295, 77, 172,
    /*   360 */ 171, 170, 163, 162, 89, 17, 16, 13, 15, 14,
    /*   370 */ 148, 295, 17, 16, 13, 15, 14, 17, 16, 13,
    /*   380 */ 15, 14, 147, 295, 17, 16, 13, 15, 14, 62,
    /*   390 */ 138, 295, 295, 175, 9, 295, 295, 172, 171, 170,
    /*   400 */ 265, 265, 295, 138, 70, 137, 295, 295, 295, 295,
    /*   410 */ 172, 171, 170, 174, 169, 168, 167, 69, 137, 138,
    /*   420 */ 139, 266, 266, 138, 295, 295, 172, 171, 170, 295,
    /*   430 */ 172, 171, 170, 68, 137, 138, 295, 67, 137, 138,
    /*   440 */ 295, 139, 172, 171, 170, 295, 172, 171, 170, 66,
    /*   450 */ 137, 164, 295, 65, 137, 295, 164, 83, 172, 171,
    /*   460 */ 170, 163, 84, 172, 171, 170, 163, 295, 164, 267,
    /*   470 */ 267, 295, 295, 164, 96, 172, 171, 170, 163, 95,
    /*   480 */ 172, 171, 170, 163, 295, 164, 295, 295, 295, 139,
    /*   490 */ 164, 94, 172, 171, 170, 163, 76, 172, 171, 170,
    ...
    /*   560 */ 165, 172, 171, 170, 295, 159, 165, 172, 171, 170,
    /*   570 */ 295, 158, 165, 172, 171, 170, 295, 157, 295, 172,
    /*   580 */ 171, 170, 165, 156, 295, 295, 295, 165, 295, 172,
    /*   590 */ 171, 170, 165, 155, 172, 171, 170, 165, 154, 172,
    /*   600 */ 171, 170, 165, 153, 172, 171, 170, 165, 152, 172,
    /*   610 */ 171, 170, 295, 151, 172, 171, 170, 165, 150, 295,
    /*   620 */ 295, 295, 165, 295, 172, 171, 170, 165, 149, 172,
    /*   630 */ 171, 170, 295, 146, 172, 171, 170, 165, 145, 295,
    /*   640 */ 295, 295, 165, 295, 172, 171, 170, 165, 144, 172,
    /*   650 */ 171, 170, 165, 143, 172, 171, 170, 165, 142, 172,
    /*   660 */ 171, 170, 138, 141, 172, 171, 170, 130, 140, 172,
    /*   670 */ 171, 170, 130, 295, 172, 171, 170, 121, 130, 172,
    /*   680 */ 171, 170, 295, 130, 27, 172, 171, 170, 295, 128,
    /*   690 */ 172, 171, 170, 295, 295, 34, 295, 130, 295, 295,
    /*   700 */ 127, 130, 295, 295, 172, 171, 170, 295, 172, 171,
    /*   710 */ 170, 295, 130, 295, 126, 295, 295, 130, 31, 172,
    /*   720 */ 171, 170, 295, 130, 172, 171, 170, 295, 130, 125,
    /*   730 */ 172, 171, 170, 295, 29, 172, 171, 170, 295, 130,
    /*   740 */ 124, 295, 130, 295, 295, 123, 172, 171, 170, 172,
    /*   750 */ 171, 170, 181, 180, 295, 295, 26, 295, 173, 122,
...
static const YYCODETYPE yy_lookahead[] = {
    ...
    /*    10 */ 81, 82, 83, 84, 74, 86, 5, 6, 7, 90,
    /*    20 */ 7, 81, 82, 83, 26, 85, 28, 29, 30, 31,
    ...
    /*    80 */ 84, 74, 86, 23, 24, 2, 90, 1, 81, 82,
    ...
    /*   130 */ 75, 1, 8, 10, 92, 80, 81, 82, 83, 84,
    /*   140 */ 74, 86, 79, 87, 90, 90, 93, 81, 82, 83,
...
static const short yy_shift_ofst[] = {
    ...
    /*    80 */ 546, 546, 546, 11, 11, 49, -44, 123, 130, 126,
    /*    90 */ 86, 67, 83, 70, 13, 13, 13, 4, 1,
};
...
static const short yy_reduce_ofst[] = {
    ...
    /*    60 */ 701, 696, 690, 158, 54, 56, 56, 56, 56, 56,
    /*    70 */ 56, 63, 42,
};
...
static const YYACTIONTYPE yy_default[] = {
    ...
    /*    80 */ 272, 271, 213, 226, 227, 293, 269, 293, 293, 293,
    /*    90 */ 293, 293, 293, 293, 252, 247, 228, 293, 293, 207,
    /*   100 */ 211, 210, 209, 208, 204, 203, 187, 212, 202, 201,
    /*   110 */ 200, 199, 198, 197, 196, 195, 194, 233, 232, 231,
    /*   120 */ 258, 263, 285, 291, 290, 289, 283, 287, 286, 284,
    /*   130 */ 281, 280, 279, 278, 277, 261, 259, 262, 260, 254,
    /*   140 */ 276, 275, 274, 273, 253, 251, 250, 249, 248, 246,
    /*   150 */ 245, 244, 243, 242, 241, 240, 239, 238, 237, 236,
    /*   160 */ 235, 234, 229, 224, 223, 230, 225, 222, 221, 220,
...
#line 1186 "expr_parse.c"
            break;
        case 2:                /* pin ::= pbits_list */
        case 4:                /* pbits_list ::= pbits */
            yytestcase(yyruleno == 4);
        case 7:                /* pbits ::= STRING */
            yytestcase(yyruleno == 7);
        case 8:                /* pbits ::= QUOTED_STRING */
            yytestcase(yyruleno == 8);
        case 9:                /* pbits ::= ESCAPE_STRING */
            yytestcase(yyruleno == 9);
        case 11:               /* pbits ::= EQUALS */
...
#line 1204 "expr_parse.c"
            break;
        case 3:                /* pin ::= pbits_list NEWLINE */
#line 91 "expr_parse.y"
            {
                token_copy(&yygotominor.yy0, &yymsp[-1].minor.yy0);
                yy_destructor(yypParser, 9, &yymsp[0].minor);
            }
#line 1210 "expr_parse.c"
            break;
        case 5:                /* pbits_list ::= pbits_list pbits */
#line 94 "expr_parse.y"
            {
                token_append(&yygotominor.yy0, &yymsp[-1].minor.yy0,
                             &yymsp[0].minor.yy0);
            }
#line 1215 "expr_parse.c"
            break;
        case 6:                /* pbits ::= number */
...
#line 1220 "expr_parse.c"
            break;
        case 10:               /* pbits ::= LPAREN expr RPAREN */
#line 100 "expr_parse.y"
            {
                yymsp[-1].minor.yy0.col = yymsp[-2].minor.yy0.col;
                token_copy(&yygotominor.yy0, &yymsp[-1].minor.yy0);
...
#line 1303 "expr_parse.c"
            break;
        case 27:               /* evalo ::= AS FLOAT */
#line 158 "expr_parse.y"
            {
                eval_asfloat = 1;
                yymsp[-1].minor.yy0.type = yymsp[0].minor.yy0.type = STRING;
                token_append(&yygotominor.yy0, &yymsp[-1].minor.yy0,
                             &yymsp[0].minor.yy0);
            }
...
#line 191 "expr_parse.y"
            {
                token_value(&yygotominor.yy0, -yymsp[0].minor.yy0.value,
                            yymsp[-1].minor.yy0.col);
            }
...
#line 196 "expr_parse.y"
            {
                if (!token_var
                    (&yygotominor.yy0, BLACKBOARD, yymsp[0].minor.yy0.str,
                     yymsp[0].minor.yy0.col)) {
                    parse_error(value,
...
#line 209 "expr_parse.y"
            {
                if (!token_var
                    (&yygotominor.yy0, HEADER, yymsp[0].minor.yy0.str,
                     yymsp[0].minor.yy0.col)) {
                    parse_error(value,
...
#line 1380 "expr_parse.c"
            break;
        case 39:               /* key ::= VARIABLE */
#line 215 "expr_parse.y"
            {
                if (!token_var
                    (&yygotominor.yy0, VARIABLE, yymsp[0].minor.yy0.str,
                     yymsp[0].minor.yy0.col)) {
                    parse_error(value,
...
#line 1405 "expr_parse.c"
            break;
        case 43:               /* state ::= state PLUS state */
#line 226 "expr_parse.y"
            {
                token_value(&yygotominor.yy0,
                            yymsp[-2].minor.yy0.value +
                            yymsp[0].minor.yy0.value, yymsp[-2].minor.yy0.col);
                yy_destructor(yypParser, 3, &yymsp[-1].minor);
            }
#line 1411 "expr_parse.c"
            break;
...
#line 1435 "expr_parse.c"
        ...
        case 49:               /* num_or_pstate ::= LPAREN sac_math RPAREN */
...
#line 236 "expr_parse.y"
            {
                token_value(&yygotominor.yy0, sin(yymsp[0].minor.yy0.value),
                            yymsp[-1].minor.yy0.col);
            }
...
#line 237 "expr_parse.y"
            {
                token_value(&yygotominor.yy0, cos(yymsp[0].minor.yy0.value),
                            yymsp[-1].minor.yy0.col);
            }
...
#line 238 "expr_parse.y"
            {
                token_value(&yygotominor.yy0, tan(yymsp[0].minor.yy0.value),
                            yymsp[-1].minor.yy0.col);
            }
...
#line 240 "expr_parse.y"
            {
                token_value(&yygotominor.yy0, sinh(yymsp[0].minor.yy0.value),
                            yymsp[-1].minor.yy0.col);
            }
...
#line 241 "expr_parse.y"
            {
                token_value(&yygotominor.yy0, cosh(yymsp[0].minor.yy0.value),
                            yymsp[-1].minor.yy0.col);
            }
...
#line 242 "expr_parse.y"
            {
                token_value(&yygotominor.yy0, tanh(yymsp[0].minor.yy0.value),
                            yymsp[-1].minor.yy0.col);
            }
...
#line 244 "expr_parse.y"
            {
                token_value(&yygotominor.yy0, asin(yymsp[0].minor.yy0.value),
                            yymsp[-1].minor.yy0.col);
            }
...
#line 245 "expr_parse.y"
            {
                token_value(&yygotominor.yy0, acos(yymsp[0].minor.yy0.value),
                            yymsp[-1].minor.yy0.col);
            }
...
#line 246 "expr_parse.y"
            {
                token_value(&yygotominor.yy0, atan(yymsp[0].minor.yy0.value),
                            yymsp[-1].minor.yy0.col);
            }
...
#line 248 "expr_parse.y"
            {
                token_value(&yygotominor.yy0, fabs(yymsp[0].minor.yy0.value),
                            yymsp[-1].minor.yy0.col);
            }
...
#line 249 "expr_parse.y"
            {
                token_value(&yygotominor.yy0, floor(yymsp[0].minor.yy0.value),
                            yymsp[-1].minor.yy0.col);
            }
...
#line 250 "expr_parse.y"
            {
                token_value(&yygotominor.yy0, ceil(yymsp[0].minor.yy0.value),
                            yymsp[-1].minor.yy0.col);
            }
...
#line 251 "expr_parse.y"
            {
                token_value(&yygotominor.yy0, exp(yymsp[0].minor.yy0.value),
                            yymsp[-1].minor.yy0.col);
            }
...
#line 252 "expr_parse.y"
            {
                token_value(&yygotominor.yy0, round(yymsp[0].minor.yy0.value),
                            yymsp[-1].minor.yy0.col);
            }
...
#line 254 "expr_parse.y"
            {
                if (yymsp[-2].minor.yy0.value < 0.0 &&
                    fabs(round(yymsp[0].minor.yy0.value) -
                         yymsp[0].minor.yy0.value) >= 1e-15) {
                    parse_error(value,
                                TOKEN_STATUS_ERROR_NEGATIVE_FRACTION_POWER);
                } else {
                    token_value(&yygotominor.yy0,
                                pow(yymsp[-2].minor.yy0.value,
                                    yymsp[0].minor.yy0.value),
                                yymsp[-2].minor.yy0.col);
                }
                yy_destructor(yypParser, 7, &yymsp[-1].minor);
            }
#line 1525 "expr_parse.c"
            break;
        case 65:               /* func ::= ATAN2 LPAREN state COMMA state RPAREN */
#line 262 "expr_parse.y"
            {
                token_value(&yygotominor.yy0,
                            atan2(yymsp[-3].minor.yy0.value,
                                  yymsp[-1].minor.yy0.value),
                            yymsp[-5].minor.yy0.col);
                yy_destructor(yypParser, 2, &yymsp[-4].minor);
                yy_destructor(yypParser, 20, &yymsp[-2].minor);
                yy_destructor(yypParser, 1, &yymsp[0].minor);
            }
#line 1535 "expr_parse.c"
            break;
        case 66:               /* func ::= LENGTH LPAREN state COMMA state RPAREN */
#line 265 "expr_parse.y"
            {
                token_value(&yygotominor.yy0,
                            sqrt(yymsp[-3].minor.yy0.value *
                                 yymsp[-3].minor.yy0.value +
                                 yymsp[-1].minor.yy0.value *
                                 yymsp[-1].minor.yy0.value),
                            yymsp[-5].minor.yy0.col);
                yy_destructor(yypParser, 2, &yymsp[-4].minor);
...
#line 289 "expr_parse.y"
            {
                if (yymsp[0].minor.yy0.value >= 0.0) {
                    token_value(&yygotominor.yy0,
                                sqrt(yymsp[0].minor.yy0.value),
                                yymsp[-1].minor.yy0.col);
                } else {
                    parse_error(value, TOKEN_STATUS_ERROR_SQRT_NEGATIVE);
                }
            }
#line 1591 "expr_parse.c"
            break;
...
#line 327 "expr_parse.y"
            {
                token_value(&yygotominor.yy0,
                            token_foreach(&yymsp[0].minor.yy0, token_min),
                            yymsp[-1].minor.yy0.col);
                token_free(yymsp[0].minor.yy0.next);
            }
#line 1606 "expr_parse.c"
            break;
        case 74:               /* sac_math ::= MAXIMUM xlist */
#line 335 "expr_parse.y"
            {
                token_value(&yygotominor.yy0,
                            token_foreach(&yymsp[0].minor.yy0, token_max),
                            yymsp[-1].minor.yy0.col);
                token_free(yymsp[0].minor.yy0.next);
            }
#line 1614 "expr_parse.c"
            break;
        case 75:               /* state ::= LPAREN sac_math RPAREN */
        case 78:               /* list_item ::= LPAREN expr RPAREN */
...
#line 347 "expr_parse.y"
            {
                token_append(&yygotominor.yy0, &yymsp[-2].minor.yy0,
                             &yymsp[0].minor.yy0);
            }
...
#line 349 "expr_parse.y"
            {
                token_value(&yygotominor.yy0,
                            token_foreach(&yymsp[0].minor.yy0, token_add),
                            yymsp[-1].minor.yy0.col);
            }
...
#line 350 "expr_parse.y"
            {
                token_value(&yygotominor.yy0,
                            token_foreach(&yymsp[0].minor.yy0, token_sub),
                            yymsp[-1].minor.yy0.col);
            }
...
#line 351 "expr_parse.y"
            {
                token_value(&yygotominor.yy0,
                            token_foreach(&yymsp[0].minor.yy0, token_mul),
                            yymsp[-1].minor.yy0.col);
            }
...
#line 352 "expr_parse.y"
            {
                token_value(&yygotominor.yy0,
                            token_foreach(&yymsp[0].minor.yy0, token_div),
                            yymsp[-1].minor.yy0.col);
            }
#line 1647 "expr_parse.c"
            break;
...
#line 375 "expr_parse.y"
            {
                if (!gettime_expr
                    (&yygotominor.yy0, &yymsp[0].minor.yy0, FALSE, TRUE)) {
                    parse_error(value, TOKEN_STATUS_ERROR_GETTIME);
                } else {
...
#line 1694 "expr_parse.c"
            break;
        case 89:               /* sac_math ::= GETTIME MAXIMUM state */
#line 382 "expr_parse.y"
            {
                if (!gettime_expr
                    (&yygotominor.yy0, &yymsp[0].minor.yy0, TRUE, TRUE)) {
                    parse_error(value, TOKEN_STATUS_ERROR_GETTIME);
                } else {
                    yygotominor.yy0.col = yymsp[-2].minor.yy0.col;
                }
...
#line 391 "expr_parse.y"
            {
                token_value(&yygotominor.yy0, (int) yymsp[0].minor.yy0.value,
                            yymsp[-1].minor.yy0.col);
            }
...
#line 392 "expr_parse.y"
            {
                token_value(&yygotominor.yy0, pow(10, yymsp[0].minor.yy0.value),
                            yymsp[-1].minor.yy0.col);
            }
...
#line 1727 "expr_parse.c"
            break;
        case 95:               /* string ::= STRING */
        case 96:               /* string ::= QUOTED_STRING */
            yytestcase(yyruleno == 96);
        case 97:               /* string ::= ESCAPE_STRING */
            yytestcase(yyruleno == 97);
#line 412 "expr_parse.y"
            {
                token_string(&yygotominor.yy0, yymsp[0].minor.yy0.str,
                             yymsp[0].minor.yy0.col);
            }
...
#line 415 "expr_parse.y"
            {
                if (yymsp[0].minor.yy0.type == NUM) {
                    char *s;
                    if (floor(yymsp[0].minor.yy0.value) ==
                        yymsp[0].minor.yy0.value) {
...
#line 431 "expr_parse.y"
            {
                if (yymsp[-1].minor.yy0.str && yymsp[0].minor.yy0.str) {
                    ...
                    token_string(&yygotominor.yy0, strdup(string_string(s)),
                                 yymsp[-1].minor.yy0.col);
                    string_free(&s);
...
#line 455 "expr_parse.y"
            {
                string *s = string_new(yymsp[0].minor.yy0.str);
                string *s2 =
                    string_substr(s, (int) yymsp[-2].minor.yy0.value - 1,
                                  (int) yymsp[-1].minor.yy0.value -
                                  (int) yymsp[-2].minor.yy0.value + 1);
                token_string(&yygotominor.yy0, strdup(string_string(s2)),
                             yymsp[-3].minor.yy0.col);
                string_free(&s);
                string_free(&s2);
                FREE(yymsp[0].minor.yy0.str);
            }
#line 1803 "expr_parse.c"
            break;
...
#line 472 "expr_parse.y"
            {
                yymsp[0].minor.yy0.col = yymsp[-1].minor.yy0.col;
                token_copy(&yygotominor.yy0, &yymsp[0].minor.yy0);
            }
#line 1820 "expr_parse.c"
            break;
...
#line 474 "expr_parse.y"
            {
                string *s = string_new(yymsp[0].minor.yy0.str);
                char *f =
                    strstr(yymsp[0].minor.yy0.str, yymsp[-1].minor.yy0.str);
...
#line 492 "expr_parse.y"
            {
                ...
                if (fgets(in, 1024, stdin) == NULL) {
                    ...
                    if (strlen(in) <= 0) {
                        if (isnumx(def)) {
                            token_value(&yygotominor.yy0, atof(def),
                                        yymsp[-1].minor.yy0.col);
                        } else {
                            token_string(&yygotominor.yy0, strdup(def),
                                         yymsp[-1].minor.yy0.col);
                        }
                    } else {
                        if (isnumx(in)) {
                            token_value(&yygotominor.yy0, atof(in),
                                        yymsp[-1].minor.yy0.col);
                        } else {
                            token_string(&yygotominor.yy0, strdup(in),
                                         yymsp[-1].minor.yy0.col);
                        }
                    }
                }
                ...
                while (yypParser->yyidx >= 0 && yymx != YYERRORSYMBOL &&
                       (yyact =
                        yy_find_reduce_action(yypParser->
                                              yystack[yypParser->yyidx].stateno,
