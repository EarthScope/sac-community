...
*/
void
ParseNoOpTrace(FILE * TraceFILE, char *zTracePrompt) {
...
*/
void *
ParseNoOpAlloc(void *(*mallocProc) (size_t)) {
    yyParser *pParser;
...
*/
void
ParseNoOpFree(void *p,          /* The parser to be deleted */
