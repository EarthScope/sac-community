...
HelpOnDBname() {
    char help[] =
        ...
        "As of version 0.59, DBname is no longer stored as such.\n"
...
HelpOnDefaults() {
    char help[] =
        ...
        "Oracle login name:     dodge\n" "Oracle login password: dodge\n"
        "Restrict phases to:  \n" "Restrict authors to:  \n\n"
        ...
        "OracleLoginName = dodge\n" "! This is a comment\n"
        "# In fact all text preceded by !#/; are comments\n"
        "OraclePassword = dodge  !This is a trailing comment\n"
...
void
DisplaySpecificHelp(char *option, char *subOption) {
    char *token;
