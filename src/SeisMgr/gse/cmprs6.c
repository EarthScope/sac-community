     ...
     char **theString;
{
    ...
    if (*npts + 1 == *space) {
        ...
        temp =
            (char *) realloc(*theString, (*space + EIGHTYONE) * sizeof(char));
        if (temp == NULL) {
            (*theString)[*npts] = '\0';
            rt = 1;
        } else {
     ...
     char **CBUFF;
{
    ...
    int
      N4 = 16,                  /* 2 raised to the 4th power */
        ...
        N9 = 512, N10 = 1024, N10M1 = 1023, N14 = 16384, N15 = 32768, N15M1 =
        32767, N19 = 524288, N20 = 1048576, N20M1 = 1048575, N24 =
        16777216, N25 = 33554432, N25M1 = 33554431, N28M1 = 134217727;
...
/*            FILL A BYTE IF HERE NUMBER WILL REQUIRE SIX BYTES */
        ...
        if ((ierror = room(&ioff, &space, CBUFF)))
            goto L_80;
        (*CBUFF)[ioff] = ACHAR[J];
        ioff++;
        JN &= N25M1;
