 ...
 */
void
pltplr(float *s, int naz, int ninc, int levels, char *scalng, int lprint,
       char *label, int label_s, char *title, int title_s) {

    int lany, lfullsav;
    int _l0, i, iend_, lenlab, nerr, np, ptr;
    float angle, aspect, ratiosav, side, smax_, txtxps, txtyin, txtyps, xd,
        xleft, xright, xym, ybot, yd, ytop, zhigh, zlow;
    char *strtemp;
    char *csave;
