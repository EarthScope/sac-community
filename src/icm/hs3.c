     ...
     double delfrq, xre[], xim[];
{
    ...
    for (i = 1; i <= nfreq; i++) {
        ...
        cht =
            cmplxdiv(flttocmplx(2.6e3, 0.),
                     (cmplxadd
                      (cmplxadd
                       (flttocmplx(1.11e5, 0.),
                        cmplxmul(flttocmplx(33.3, 0.), cs)), cmplxpow(cs,
                                                                      (double)
                                                                      2))));
        chhp =
            cmplxdiv(cmplxmul(flttocmplx(16.0, 0.), cs),
                     (cmplxadd
                      (flttocmplx(1.0, 0.),
        ...
        cha2 =
            cmplxneg(cmplxdiv
                     (flttocmplx(2.0, 0.),
                      (cmplxadd
                       (flttocmplx(1.0, 0.),
                        cmplxmul(flttocmplx(2.0e-5, 0.), cs)))));
        cf1 =
            cmplxdiv((cmplxadd
                      (flttocmplx(1.0, 0.),
                       cmplxmul(flttocmplx(1.7e-4, 0.), cs))),
                     (cmplxadd
                      (cmplxadd
                       (cmplxadd
                        (flttocmplx(1.0, 0.),
                         cmplxmul(flttocmplx(1.038e-3, 0.), cs)),
                        cmplxmul(flttocmplx(1.47e-7, 0.),
                                 cmplxpow(cs, (double) 2))),
                       cmplxmul(flttocmplx(1.7e-12, 0.),
        ...
        chs3 =
            cmplxmul(cmplxmul
                     (cmplxmul
                      (cmplxmul(flttocmplx(100.0, 0.), cs),
                       (cmplxdiv
                        (cha,
                         (cmplxsub(flttocmplx(1.0, 0.), cmplxmul(cha, chb)))))),
                      flttocmplx(1.0e-9, 0.)), cs);
        Xre[i] = cmplxtof(chs3);
        Xim[i] = aimag(chs3);
    }
