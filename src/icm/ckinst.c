                ...
                *nerr = 2105;
                ...
                if (temp[1] == 'E' && temp[0] != 'O') {
                    *nerr = 2105;
                    ...
                    apcmsg("SANDIA:", 8);
                    apcmsg(KP(1, 0), kp_s);
                    aplmsg("Invalid combination of \"O\" and \"E\".", 36);
                }
                if (temp[0] == 'N' &&
                    ...
                    *nerr = 2105;
                    ...
                    apcmsg("SANDIA:", 8);
                    apcmsg(KP(1, 0), kp_s);
                    aplmsg("Sub-type \"N\" must be combined with", 35);
                    apcmsg("\"V\", \"R\", or \"T\".", 18);
                }
            }
        }
        ...
        if ((strcmp(temp, "BB") == 0 || strcmp(temp, "SP") == 0) ||
            ...
            *nerr = 2105;
            ...
            if (strcmp(temp, "LPST                ") == 0)
                aplmsg("This sub-type is not currently supported.", 42);
        }
