...
void /*FUNCTION*/
cmh(int nfreq, double delfrq, double xre[], double xim[])
{
    int npole, nzero;
    double const_;
    complexd pole[25], zero[8];
    ...
    Pole[14] = dbltocmplx(-0.80650e1, 0.12880e1);
    Pole[15] = dbltocmplx(-0.72780e1, -0.37070e1);
    Pole[16] = dbltocmplx(-0.72780e1, 0.37070e1);
    Pole[17] = dbltocmplx(-0.57740e1, -0.57770e1);
    Pole[18] = dbltocmplx(-0.57740e1, 0.57770e1);
    Pole[19] = dbltocmplx(-0.37090e1, -0.72770e1);
    Pole[20] = dbltocmplx(-0.37090e1, 0.72770e1);
    Pole[21] = dbltocmplx(-0.12770e1, -0.80670e1);
    Pole[22] = dbltocmplx(-0.12770e1, 0.80670e1);
    Pole[23] = dbltocmplx(-0.31450e-1, 0.0);
    Pole[24] = dbltocmplx(-0.31450e-1, 0.0);
    Pole[25] = dbltocmplx(-0.62814e2, 0.0);
