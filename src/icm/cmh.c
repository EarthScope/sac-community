...
cmh(int nfreq, double delfrq, double xre[], double xim[])
{
    ...
    Pole[14] = (-0.80650e1) + (0.12880e1 * I);
    Pole[15] = (-0.72780e1) + ((-0.37070e1) * I);
    Pole[16] = (-0.72780e1) + (0.37070e1 * I);
    Pole[17] = (-0.57740e1) + ((-0.57770e1) * I);
    Pole[18] = (-0.57740e1) + (0.57770e1 * I);
    Pole[19] = (-0.37090e1) + ((-0.72770e1) * I);
    Pole[20] = (-0.37090e1) + (0.72770e1 * I);
    Pole[21] = (-0.12770e1) + ((-0.80670e1) * I);
    Pole[22] = (-0.12770e1) + (0.80670e1 * I);
    Pole[23] = (-0.31450e-1) + (0.0 * I);
    Pole[24] = (-0.31450e-1) + (0.0 * I);
    Pole[25] = (-0.62814e2) + (0.0 * I);
