...
void
setType(char *type, enum Direction dir) {
...
void
setTime(char *time, enum Direction dir) {
...
void
setDate(char *date, enum Direction dir) {
...
void
setStationName(char *name, enum Direction dir) {
...
void
setNetworkName(char *name, enum Direction dir) {
...
void
setLocidName(char *name, enum Direction dir) {
