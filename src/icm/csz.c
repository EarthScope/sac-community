...
csz(int nfreq, double delfrq, double xre[], double xim[])
{
    ...
    Pole[12] = dbltocmplx(-0.36389e2, -0.18545e2);
    Pole[13] = dbltocmplx(-0.36389e2, 0.18545e2);
    Pole[14] = dbltocmplx(-0.28273e1, 0.0);
    Pole[15] = dbltocmplx(-0.18541e2, -0.36391e2);
    Pole[16] = dbltocmplx(-0.18541e2, 0.36391e2);
    Pole[17] = dbltocmplx(-0.28273e1, 0.0);
    Pole[18] = dbltocmplx(-0.40342e2, -0.63705e1);
    Pole[19] = dbltocmplx(-0.40342e2, 0.63705e1);
    Pole[20] = dbltocmplx(-0.28273e1, 0.0);
    Pole[21] = dbltocmplx(-0.63878e1, -0.40339e2);
    Pole[22] = dbltocmplx(-0.63878e1, 0.40339e2);
    Pole[23] = dbltocmplx(-0.28273e1, 0.0);
    Pole[24] = dbltocmplx(-0.28882e2, -0.28877e2);
