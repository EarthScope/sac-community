...
void
InterpolateArrays(double *freqs, int nfreqs, double *tmpRe, double *tmpIm,
...
static void
setTimeString(int *hour, int *min, int *sec, int *msec, char *t_o_day) {
...
int /*FUNCTION*/
EvrespGateway(int nfreq, double delfrq, double xre[], double xim[],
