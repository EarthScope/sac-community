...
%.4s%.3s                    %.5s", kmeam.kstid, kmeam.kpwave, npyr, cmeam.npmon, cmeam.npday, cmeam.nphour, cmeam.npmin, cmeam.psecs, kssecs, kmeam.kswave, kampx, kprx, kfmp);
