    ...
    if (Ivm[jvm] == cmsss.inmo) {
        if (Lct0vm[jvm] && Lcvapp[jvm]) {
            if (Ndvm[jvm] == 2 && Ntvm[jvm] == 2) {
                vappsq =
                    (cmsss.dvm[jvm - 1][0] * cmsss.dvm[jvm - 1][0] -
                     cmsss.dvm[jvm - 1][1] * cmsss.dvm[jvm -
                                                       1][1]) / (cmsss.tvm[jvm -
                                                                           1][0]
                                                                 *
                                                                 cmsss.tvm[jvm -
                ...
                if (vappsq > 0.) {
                    ...
                    t0vmsq =
                        cmsss.tvm[jvm - 1][0] * cmsss.tvm[jvm - 1][0] -
            ...
            if (Ndvm[jvm] >= 1 && Ntvm[jvm] >= 1) {
                ...
                vappsq =
                    cmsss.dvm[jvm - 1][0] * cmsss.dvm[jvm -
                                                      1][0] /
        ...
        if (Lct0vm[jvm] && Lcvapp[jvm]) {
            if (Ndvm[jvm] == 2 && Ntvm[jvm] == 2) {
                Vapp[jvm] =
                    (cmsss.dvm[jvm - 1][0] -
                     cmsss.dvm[jvm - 1][1]) / (cmsss.tvm[jvm - 1][0] -
                                               cmsss.tvm[jvm - 1][1]);
                T0vm[jvm] =
                    cmsss.tvm[jvm - 1][0] - cmsss.dvm[jvm - 1][0] / Vapp[jvm];
            } else {
                *nerr = 5112;
                setmsg("ERROR", *nerr);
                apimsg(Ndvm[jvm]);
            ...
            if (Ndvm[jvm] >= 1 && Ntvm[jvm] >= 1) {
                Vapp[jvm] =
                    cmsss.dvm[jvm - 1][0] / (cmsss.tvm[jvm - 1][0] - T0vm[jvm]);
            } else {
                *nerr = 5112;
                setmsg("ERROR", *nerr);
                apimsg(Ndvm[jvm]);
