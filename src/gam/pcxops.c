...
void
pcxops(int iop1, int iop2, float xloc[], float yloc[], double degi) {
    ...
    if (((deg2 - deg1) < 180. && iop2 == 1) ||
        ((deg2 - deg1) >= 180. && iop2 == 2)) {
        worldsector(Xloc[1], Yloc[1], radius, deg1, deg2, degi);
    } else {
        worldsector(Xloc[1], Yloc[1], radius, deg2, deg1 + 360., degi);
    }
