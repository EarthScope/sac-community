     ...
     int nxsize, nysize, *nerr;
{
    ...
    float a0, a1, a2, a3, a4, a5, a6, a7, delx, dely, dmax, dmin, pos[4][2],
        test, xbase, ybase, zll, zlr, zmax, zmin, zul, zur;
    ...
    *nerr = 0;
    ...
    allocpoints(cmcontouring.maxpoints, &cmcontouring.indexpoints,
                &cmcontouring.indexlinks, &cmcontouring.indexrlinks,
                &cmcontouring.indexaction, nerr);
    if (*nerr != 0)
        goto L_8888;
    ...
    delx = (cmgtm.xvpmax - cmgtm.xvpmin) / (float) (jxstop - jxstart + 1);
    dely = (cmgtm.yvpmax - cmgtm.yvpmin) / (float) (jystop - jystart + 1);
    zmin = Zlevels[1];
