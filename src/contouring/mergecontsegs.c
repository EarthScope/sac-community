...
mergecontsegs() {
    int again, merged;
    int jactionstarta, jactionstartb, jactionstopa, jactionstopb, jlevela,
        jlevelb, jlink, jlinkstarta, jlinkstartb, jlinkstopa, jlinkstopb,
        jsegmenta, jsegmentb, jstarta, jstartb, jstopa, jstopb;
        ...
        if (nextcontseg(&jsegmenta, &jlevela, &jstarta, &jstopa)) {
          ...
          L_3000:
            if (nextcontseg(&jsegmentb, &jlevelb, &jstartb, &jstopb)) {
                ...
                if ((jlevela == jlevelb && jstarta > 0) && jstartb > 0) {
                    ...
                    if (merged) {
                        ...
                        getcontseg(jsegmenta, &jlevela, &jstarta, &jstopa);
                        again = TRUE;
                    }
                }
                goto L_3000;
