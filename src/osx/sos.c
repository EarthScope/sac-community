...
complex *
freqz(int n, float *b, float *a, int nin) {
...
void
sos_freqz(int ns, float *sn, float *sd, float dt, int n, float *freq,
...
void
filter_response(char *type, char *proto, int order, float low, float high,
                double dt, int n, float *freq, float *amp, float *phase) {
    int nsects;
    float sd[30], sn[30];
    design(order, type, proto, 0.0, 0.0, low, high, dt, sn, sd, &nsects);
