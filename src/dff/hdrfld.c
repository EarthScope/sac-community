 ...
 */
void
hdrfld(char *kname, int kname_s, int *icat, int *item, int *lfound) {
...
void
hdrfldf(char *kname, int *icat, int *item, int *lfound, int kname_s) {
    hdrfld(kname, kname_s, icat, item, lfound);
}

void
hdrfldf_(char *kname, int *icat, int *item, int *lfound, int kname_s) {
    hdrfld(kname, kname_s, icat, item, lfound);
}

void
hdrfldf__(char *kname, int *icat, int *item, int *lfound, int kname_s) {
    hdrfld(kname, kname_s, icat, item, lfound);
}
