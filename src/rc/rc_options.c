...
void
set_color_foreground(void *v) {
    char *c = (char *) v;
    SOUT("color.foreground", c);
    color_foreground_set_by_name(c);
}

void
set_color_background(void *v) {
    char *c = (char *) v;
    SOUT("color.background", c);
    color_background_set_by_name(c);
}

void
set_color_skeleton(void *v) {
    char *c = (char *) v;
    SOUT("color.skeleton", c);
    color_skeleton_set_by_name(c);
}

void
set_color_data(void *v) {
    char *c = (char *) v;
    SOUT("color.data", c);
    color_data_set_by_name(c);
}

void
set_color_increment(void *v) {
    int *i = (int *) v;
    BOUT("color.increment", *i);
    color_increment_set(*i);
}

/* History */
void
set_history_length(void *v) {
    int *i = (int *) v;
    IOUT("history.max", *i);
    history_size_set(*i);
}
...
/* PPK */
void
set_ppk_crosshair_size(void *v) {
    int *i = (int *) v;
    BOUT("ppk.large_crosshairs", *i);
    use_large_crosshairs(*i);
}
...
void
set_xdiv_increment(void *v) {
    float *i = (float *) v;
    ROUT("xdiv.increment", *i);
    xdiv_increment(*i);
}

/* Y Divisions */
void
set_ydiv_power(void *v) {
    int *i = (int *) v;
    BOUT("ydiv.power", *i);
    ydiv_power(*i);
}
...
void
set_ydiv_increment(void *v) {
    float *i = (float *) v;
    ROUT("ydiv.increment", *i);
    ydiv_increment(*i);
}
...
void
set_xlabel_location(void *v) {
    char *c = (char *) v;
    SOUT("xlabel.location", c);
    xlabel_location(c);
}

void
set_xlabel_size(void *v) {
    char *c = (char *) v;
    SOUT("xlabel.size", c);
    xlabel_size(c);
}
...
void
set_ylabel_location(void *v) {
    char *c = (char *) v;
    SOUT("ylabel.location", c);
    ylabel_location(c);
}

void
set_ylabel_size(void *v) {
    char *c = (char *) v;
    SOUT("ylabel.size", c);
    ylabel_size(c);
}
