    ...
    if (llefax || lleftc) {
        ...
        for (jfac = 2; jfac <= 9; jfac++) {
            ...
            if (yrefs >= ypmnf && yrefs <= ypmxf) {
                ...
                if (lsectc) {
                    line(cmgtm.xvpmin, yrefs, cmgtm.xvpmin + 0.5 * chwid,
                         yrefs);
                }
            }
        }
        ...
        for (jdec = idecmn; jdec <= idecmx; jdec += idecin) {
            ...
            line(cmgtm.xvpmin, yref, cmgtm.xvpmin + chwid, yref);
            for (jfac = 2; jfac <= 9; jfac++) {
                jfac_ = jfac - 1;
                yrefs = yref + cmgtm.fac[jfac_] * cmgtm.ympwv1;
                if (yrefs <= ypmxf) {
                    ...
                    if (lsectc) {
                        line(cmgtm.xvpmin, yrefs, cmgtm.xvpmin + .5 * chwid,
                             yrefs);
                    }
                }
            }
    ...
    if (lrigax || lrigtc) {
        ...
        for (jfac = 2; jfac <= 9; jfac++) {
            ...
            if (yrefs >= ypmnf && yrefs <= ypmxf) {
                ...
                if (lsectc) {
                    line(cmgtm.xvpmax, yrefs, cmgtm.xvpmax - 0.5 * chwid,
                         yrefs);
                }
            }
        }
        ...
        for (jdec = idecmn; jdec <= idecmx; jdec += idecin) {
            ...
            line(cmgtm.xvpmax, yref, cmgtm.xvpmax - chwid, yref);
            for (jfac = 2; jfac <= 9; jfac++) {
                jfac_ = jfac - 1;
                yrefs = yref + cmgtm.fac[jfac_] * cmgtm.ympwv1;
                if (yrefs <= ypmxf) {
                    ...
                    if (lsectc) {
                        line(cmgtm.xvpmax, yrefs, cmgtm.xvpmax - .5 * chwid,
                             yrefs);
                    }
                    if (cmgem.lygrd) {
