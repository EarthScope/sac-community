...
OnOrOff(char *inString)
{
    ...
    if (strncmp(dumb, "ON", 2) == 0 || strncmp(dumb, "on", 2) == 0 ||
        strncmp(dumb, "On", 2) == 0 || strncmp(dumb, "oN", 2) == 0)
        OnOrOff_v = TRUE;

    else if (strncmp(dumb, "OF", 2) == 0 || strncmp(dumb, "of", 2) == 0 ||
             strncmp(dumb, "Of", 2) == 0 || strncmp(dumb, "oF", 2) == 0)
        OnOrOff_v = FALSE;
