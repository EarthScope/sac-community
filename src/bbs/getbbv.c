 ...
 */
void
getbbv(char *kname, char *kvalue, int *nerr, int kname_s, int kvalue_s) {
...
void
getbbv_(char *kname, char *kvalue, int *nerr, int kname_s, int kvalue_s) {
    getbbv(kname, kvalue, nerr, kname_s, kvalue_s);
}

void
getbbv__(char *kname, char *kvalue, int *nerr, int kname_s, int kvalue_s) {
    getbbv(kname, kvalue, nerr, kname_s, kvalue_s);
}
