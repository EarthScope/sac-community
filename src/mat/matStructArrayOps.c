...
void
matSetDoubleField(mxArray * structPtr, double *dblVal, char *fieldName,
                  int rows, int cols) {
    mxArray *field_value;
...
void
matUpdateDouble(mxArray * structPtr, double *dblVal) {
#     include "matFuncInternal.h"
    if (structPtr) {
...
void
matUpdateString(mxArray * structPt, char *string) {
#     include "matFuncInternal.h"
    if (structPt) {
...
mxArray *
matCreateDepMecStruct(struct hdrDepMec * depmec) {
#     include "matFuncInternal.h"
    ...
    if (structPtr == NULL) {
        fprintf(stderr,
                "ERROR: Could not create struct array in matCreateDepMecStruct.\n");
        exit(-1);
    }
    ...
    matSetDoubleField(structPtr, &depmec->lowerfiltercorner,
                      "lowerfiltercorner", 1, 1);

    /* Populate the upperfiltercorner field. */
    matSetDoubleField(structPtr, &depmec->upperfiltercorner,
                      "upperfiltercorner", 1, 1);

    /* Populate the mtisotropicfraction field. */
    matSetDoubleField(structPtr, &depmec->mtisotropicfraction,
                      "mtisotropicfraction", 1, 1);

    return structPtr;
}

mxArray *
matCreateDescripStruct(struct hdrDataDescrip * descrip) {
#     include "matFuncInternal.h"
    int ndim = 2, dims[2] = { 1, 1 };
    int nFields = 10;
    const char *field_names[] =
        { "iftype", "idep", "iztype", "iinst", "istreg", "ievreg",
    ...
    if (structPtr == NULL) {
        fprintf(stderr,
                "ERROR: Could not create struct array in matCreateDescripStruct.\n");
        exit(-1);
    }
...
mxArray *
matCreateUserStructArray(struct hdrUser * user) {
#     include "matFuncInternal.h"
    ...
    if (structPtr == NULL) {
        fprintf(stderr,
                "ERROR: Could not create struct array in matCreateUserStructArray.\n");
        exit(-1);
    }
...
mxArray *
matCreateEventStruct(struct hdrEvent * event) {
#     include "matFuncInternal.h"
    int ndim = 2, dims[2] = { 1, 1 };
    int nFields = 14;
    const char *field_names[] =
        { "evla", "evlo", "evel", "evdp", "nzyear", "nzjday", "nzhour",
    ...
    if (structPtr == NULL) {
        fprintf(stderr,
                "ERROR: Could not create struct array in matCreateEventStruct.\n");
        exit(-1);
    }
...
mxArray *
matCreateEvstaStruct(struct hdrEventSta * evsta) {
#     include "matFuncInternal.h"
    int ndim = 2, dims[2] = { 1, 1 };
    int nFields = 4;
    ...
    if (structPtr == NULL) {
        fprintf(stderr,
                "ERROR: Could not create struct array in matCreateEvstaStruct.\n");
        exit(-1);
    }
...
mxArray *
matCreateLLNLStruct(struct hdrLLNLextensions * llnl) {
#     include "matFuncInternal.h"
    int ndim = 2, dims[2] = { 1, 1 };
    int nFields = 9;
    const char *field_names[] =
    ...
    if (structPtr == NULL) {
        fprintf(stderr,
                "ERROR: Could not create struct array in matCreateLLNLStruct.\n");
        exit(-1);
    }
...
mxArray *
matCreateStationStruct(struct hdrStation * station) {
#     include "matFuncInternal.h"
    int ndim = 2, dims[2] = { 1, 1 };
    int nFields = 9;
    ...
    if (structPtr == NULL) {
        fprintf(stderr,
                "ERROR: Could not create struct array in matCreateStationStruct.\n");
        exit(-1);
    }
...
mxArray *
matCreateTimesStruct(struct hdrTimes * times) {
#     include "matFuncInternal.h"
    int ndim = 2, dims[2] = { 1, 1 };
    int nFields = 29;
    const char *field_names[] =
        { "delta", "b", "e", "o", "a", "t0", "t1", "t2", "t3", "t4",
    ...
    if (structPtr == NULL) {
        fprintf(stderr,
                "ERROR: Could not create struct array in matCreateTimesStruct.\n");
        exit(-1);
    }
...
void
matUpdateTimesStruct(mxArray * structPtr, struct hdrTimes *times) {
#     include "matFuncInternal.h"
    mxArray *field_value;
    ...
    for (j = 0; j < 9; j++) {
        ...
        if (field_value)
            matUpdateDouble(field_value, &times->t[j]);
    }
...
void
matUpdateStationStruct(mxArray * structPtr, struct hdrStation *station) {
#     include "matFuncInternal.h"
    mxArray *field_value;
...
void
matUpdateEventStruct(mxArray * structPtr, struct hdrEvent *event) {
#     include "matFuncInternal.h"
    mxArray *field_value;
...
void
matUpdateUserStruct(mxArray * structPtr, struct hdrUser *user) {
#     include "matFuncInternal.h"
    int j;
    mxArray *field_value;
...
void
matUpdateDescripStruct(mxArray * structPtr, struct hdrDataDescrip *descrip) {
#     include "matFuncInternal.h"
    mxArray *field_value;
...
void
matUpdateEvstaStruct(mxArray * structPtr, struct hdrEventSta *evsta) {
#     include "matFuncInternal.h"
    mxArray *field_value;
...
void
matUpdateLLNLStruct(mxArray * structPtr, struct hdrLLNLextensions *llnl) {
#     include "matFuncInternal.h"
    mxArray *field_value;
...
void
matUpdateDepMecStruct(mxArray * structPtr, struct hdrDepMec *depmec) {
#     include "matFuncInternal.h"
    mxArray *field_value;
...
void
__matStructArrayOps_undef_symbol() {
}
