     ...
     double tsize;
{
    ...
    if (itextp == TOP) {
        ...
        texty =
            fmin(cmgem.uplot.ymax + cmgem.axis[TOP].width + 0.75 * cmgem.chht,
        ...
        textx = cmgem.uplot.xmin + 0.5 * xpwid;
        texty =
            fmax(cmgem.uplot.ymin - cmgem.axis[BOTTOM].width -
                 0.75 * cmgem.chht, cmgem.view.ymin + 0.6 * cmgem.chht);
        ...
        textx =
            fmax(cmgem.uplot.xmin - cmgem.axis[LEFT].width - 0.75 * cmgem.chht,
        ...
        textx =
            fmin(cmgem.uplot.xmax + cmgem.axis[RIGHT].width + 0.75 * cmgem.chht,
